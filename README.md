...
## Installation:
Installer le repositorie: `$ git clone https://github.com/SoClosee/Telegram_ScrappingAdding_toGroup.git` <br>
Aller dans le dossier: `$ cd Telegram_ScrappingAdding_toGroup` <br>
Lancer le bot: `$ python add1.py` <br>
